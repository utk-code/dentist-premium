...
import { Shield, CheckCircle2, FileText, CreditCard, ChevronRight, HelpCircle, Sparkles, Smile, Star, QrCode, Smartphone } from 'lucide-react';
        ...
        <div className="bg-gradient-to-r from-sky-900 via-teal-900 to-slate-900 text-white rounded-3xl p-6 sm:p-10 border border-sky-800/60 shadow-lg flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="shrink-0 flex flex-col sm:flex-row lg:flex-col gap-3 w-full sm:w-auto">
            <button
              ...
              className="bg-white hover:bg-sky-50 text-slate-900 text-xs font-bold uppercase tracking-widest px-6 py-4 rounded-2xl shadow-md transition-all flex items-center justify-center gap-2 hover:scale-[1.02]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold uppercase tracking-widest px-6 py-3 rounded-2xl shadow-md transition-all text-center"
            >
              WhatsApp Us For Fee Inquiries
            </a>
          </div>
        </div>
